  ...
  <div class="chonveright">
    ...
    <div>
      <form style="font-size: 18px;" method="post" action="{{ route('thanhtoan3') }}">
        ...
        <input style="margin-top: 20px;margin-left: 80px;" name="method_pay_id" type="radio" value="vnp" checked="checked"> Thanh toán VNPay <img style="width: 70px;" src="image/vnp.png"></br>
