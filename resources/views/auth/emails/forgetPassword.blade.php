                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            ...
                                            <p>Đã có một yêu cầu thay đổi mật khẩu cho tài khoản của bạn. Nếu đây là yêu
                                                cầu của bạn, hãy bấm vào liên kết dưới đây để đặt mật khẩu mới:</p>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="text-align: center"> <a href="{{ route('reset.password.get', [$token, $email]) }}" target="_blank">Đặt lại mật khẩu</a>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
