...
//xoa docker compose
docker-compose down --volumephp8.1-
...
git clone https://github.com/dobinh3212/docker-2.git
...
git merge --squash b94f9f ce87947
...
mysql -uroot -h db web_xekhach < docker/webdatvexekhach.sql
